...
import { LayoutGrid, FileText, BarChart3, Activity, LogOut, ExternalLink, Menu, Gauge, Package, Plug, Users, Building2 } from "lucide-react";
...
type ModuleKey = "pipeline" | "propostas" | "base" | "dashboard" | "painel" | "performance";
...
const NAV_ITEMS: { key: ModuleKey; label: string; icon: typeof LayoutGrid; path: string }[] = [
  ...
  { key: "base", label: "Base", icon: Building2, path: "/admin/base" },
        ...
        <div className="flex items-center gap-2">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-52 rounded-xl p-2 shadow-lg bg-white border" style={{ borderColor: 'hsl(var(--color-border))' }}>
              ...
              {isAdmin && (
                <DropdownMenuItem onClick={() => navigate("/admin/usuarios")} className="gap-2 cursor-pointer rounded-lg">
