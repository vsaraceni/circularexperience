...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-3xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/20 border border-secondary/30 mb-6 animate-fade-up">
            ...
            <span className="text-sm font-medium text-secondary">Metodologia validada!</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed animate-fade-up" style={{ animationDelay: "0.2s" }}>
            Uma oficina prática e transformadora para pequenos negócios aplicarem os princípios 
            da circularidade e gerarem valor sustentável.
          </p>
      ...
      <div className="absolute top-40 right-20 w-32 h-32 rounded-full bg-secondary/20 blur-2xl animate-float hidden lg:block" style={{ animationDelay: "1s" }} />
    </section>
  );
};
