        ...
        <div className="max-w-3xl mx-auto">
          <div className="relative">
            ...
            {agendaItems.map((item, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-0 lg:left-1/2 lg:-translate-x-1/2 w-11 h-11 rounded-full gradient-hero flex items-center justify-center shadow-lg z-10">
                ...
                <div className={`ml-16 lg:ml-0 lg:w-[calc(50%-40px)] ${
                  ...
                  <div className="bg-card rounded-xl p-6 border border-border hover:border-primary/30 transition-all hover:shadow-lg">
                    {/* Time Badge */}
